...
export function Assistant() {
  ...
  function onChangeInputText(v: any) {
    setInput(v)
  }

  function onChangeInstructionsText(v: any) {
    setInstructions(v)
  }
  ...
  async function showClipboardActionsheet(text: any) {
  ...
  async function checkThread(_runId: any, _threadId: string) {
    try {
      let finished = false
      while (!finished) {
      ...
      data.data.forEach((data: { content: { text: any }[]; role: string }) => {
...
const getStyleSheet = (theme: { textColor: any; regularFont: any; borderColor: any; semiBoldFont: any; tintColor: any; tintTextColor: any; boldFont: any; backgroundColor: any; mediumFont: any; secondaryTextColor: any; secondaryBackgroundColor: any; lightFont: any }) => StyleSheet.create({
  chatDescription: {
    color: theme.textColor,
    textAlign: 'center',
    marginTop: 15,
